...
\section{Education}
\cventry{2007-2009}{MSc - Applied Mathematics, Research area: Mathematical Biology}{The University of Western Ontario}{London}{Ontario}{Thesis Topic: The Evolution of Cooperation on Bipartites Graph Structures}  % arguments 3 to 6 are optional
\cventry{2003-2007}{BSc - Mathematics}{Trent University}{Peterborough}{Ontario}{Dean's Honour List, 2003-2007}{Select Courses Taken: Groups, Rings and Fields, Introduction to Topology, Introduction to Dynamical Systems Mathematical Modelling}
...
\cvlistitem{Professional Mathematical Tutoring: People in industry may still have gaps in mathematical knowledge, and I would like to help them understand concepts that fill these gaps.}
\cvlistitem{Mathematics for Artists: Overlap between mathematics and the arts is significant. I would like to approach problems of mathematics from an artistic perspective.}
\cvlistitem{Python: I've been working with Python professionally for 8+ years and would enjoy working with it in a mathematical context.}
...
\cvlistitem{Working towards self-teaching myself Galois Theory based on the notes of Tom Leinster of the University of Edinburgh.}
...
\cvline{Linear Algebra}{Underappreciated but also incredibly useful.}

% \section{References}
% \cventry{Lillian Angel}{Director of Engineering}{ContactMonkey}{lillian.angel@gmail.com}

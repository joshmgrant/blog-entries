...
\cvlistitem{Creative Opportunities: In addition to writing code, I enjoy creating video, text and visual content for engineering teams.}
...
\cvlistitem{Requests: Probably the best library in Python}
\cvlistitem{Visual Studio Code: writing code and prose in several languages}
\cvlistitem{Claude Code: For analyzing large codebases, generating tests, and working through my thought processes}
\cvlistitem{Taking short walks along the lake, for excellent debugging}

\newpage

\section{Tools I've Used}
\cvlistitem{FastAPI, for writing RESTful API services that are...fast}
\cvlistitem{Django, when you need a solid web development framework}
\cvlistitem{Jenkins and GitHub Actions, for automating workflows and handling development tasks on teams}
\cvlistitem{Camtasia, for creating captivating video content}
\cvlistitem{Claude Code, for analyzing large codebases, generating tests, and working through my thought processes}
\cvlistitem{Claude, Linear, and MCP, creating and manage tickets and projects, right from your command line.}
\cvlistitem{Selenium WebDriver: For all your browser testing needs}

\section{What I've Done, in Chronological Order}
\cvlistitem{Built https://theoremsasaservice-production.up.railway.app/ as a project to learn some more math}
\cvlistitem{Built a browser-based test framework in Playwright with Typescript for a scale-up}
...
\cvlistitem{Built an API test framework for a programmatic ad platform product using Python. This tested the API layer of the internal application using approximately 200 tests with Pytest and requests.\phantom{Claude, OpenAI, agentic, forward deployed, MCP, AI, Machine Learning}
}
...
\cvlistitem{Evelyn Coleman, Manager of Implementation Engineering, Sauce Labs, coleve27@gmail.com}

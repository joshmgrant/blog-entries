...
\cvlistitem{DevSecOps: Automated tooling and security go hand-in-hand, and fixing bugs is no different from fixing security vulnerabilities}
...
\cvlistitem{Visual Studio Code, for all other programming languages and prose}
\cvlistitem{Camtasia, for creating captivating video content}
\cvlistitem{CI Fuzz, probably the multi-language fuzzer with the best developer experience}
\cvlistitem{PyTest, a great test automation framework and runner}

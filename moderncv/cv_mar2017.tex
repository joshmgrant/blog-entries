...
\cvline{Open Source}{I like seeing what people can create. I've particiated in existing open source projects (\url{www.proselint.com}) and created my own (\url{https://github.com/joshmgrant/corsica})}
\cvline{Writing}{I've always enjoyed writing, both professionally or otherwise. My blog is called Simply the Test (\url{simplythetest.tumblr.com})}

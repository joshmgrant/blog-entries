...
\cvlistitem{Python: for web development, data science, and more, I've been working with Python professionally for 8+ years}
\cvlistitem{Scientific Computing: Having some background in applied mathematics, I would like to work with scientific softwawre and programming}
\cvlistitem{Web APIs: I've tested them, I'd love to build them}
...
\cvlistitem{Python, for web development and general programming}
\cvlistitem{Visual Studio Code: writing code and prose in several languages, including HTML, C++ and Python}
...
\cvlistitem{NumPy, for working with numerical methods in science and mathematics}
\cvlistitem{Visual Studio, a powerful IDE for working with .NET including Visual C++}
\cvlistitem{Git, distributed version control for everyone}
\cvlistitem{Claude, Linear, and MCP: Create and manage tickets and projects, right from your command line.}

\section{What I've Done, in Chronological Order}
\cvlistitem{Built and maintained \href{https://theoremsasaservice-production.up.railway.app/}{Theorems as a Service}, an API-first application in Python.}
...
\cvlistitem{Wrote a C++ simulation of cooperation dynamics as part of my Master's thesis work.}

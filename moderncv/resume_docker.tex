...
\cventry{October 2023--October 2025}{Senior Software Engineer in Test}{ContactMonkey}{Toronto}{Canada}{As a senior software engineer in test, I was responsible for establishing end-to-end test automation as well as building quality engineering overall in a growing engineering organization.}
\cventry{April 2017--February 2018}{Test Developer}{JUICE Mobile}{Toronto}{Ontario}{I worked with a programmatic ad platform, primarily developing a service-level or API test framework in Python. I worked on a team of 10 developers as an "embedded" test development specialist.}                % arguments 3 to 6 are optional
...
\cvlistitem{Solution Architecture: I love building elegant solutions for complex technical problems}
\cvlistitem{Delighting Customers: Providing customers with solutions and a helping hand}
\cvlistitem{Creating Technical Guides: Technical references are great! Let's have more of them}
...
\section{Deep Dive on Solution Architect Work}
\cvlistitem{At Sauce Labs, I worked with a major American bank to implement and maintain a custom networking solution for use with our flagship product. This required both strong technical knowledge and corporate communications skills}
\cvlistitem{Also at Sauce Labs, I took on primary resposibilites to be the subject matter expert in Python-based solutions for our multi-language product and customers.}
\cvlistitem{At Code Intelligence, I worked with the marketing team to create strategic guides on technical subjects to both demonstrate our product and promote good fuzz testing practices.}

\newpage

\section{Public Speaking}
\cvlistitem{Spoke at \href{https://kwsqa.org/tq2025/schedule/}{Targeting Quality 2025}, delivering the talk "Modern}
\cvlistitem{Spoke at \href{https://2024.pybay.org/}{PyBay 2024} with the talk \href{https://www.youtube.com/watch?v=lmcTmvUsWtE}{PyTest: The Improv Way}}
\cvlistitem{Spoke at SauceCon 2022 with the talk \href{https://www.youtube.com/watch?v=vvWEWGQ5Wyw}{Selenium in the Clouds}}

\section{Video Content}
\cvlistitem{Find me on \href{https://www.tiktok.com/@joshin5colours}{TikTok}}
...
\cvline{Art}{Current interests include work by Agnes Martin, Josef Albers and modernist abstraction.}
\cvline{Being Online}{I am quite active on social media, including Mastodon \emph{mastodon.social/@joshin4colours} }

\section{References}
\cvlistitem{Lillian Angel, Director of Engineering, ContactMonkey, lillian.angel@gmail.com}
%\cventry{Khaled Yakdan}{Co-Founder and Chief Scientist}{Code Intelligence}{yakdan@code-intelligence.com}
\cvlistitem{Marcus Merrell, Staff Developer Advocate, Temporal Technologies, mmerrell@gmail.com}
\cvlistitem{Evelyn Coleman, Delivery Assurance and Customer Success Ops Manager, coleve27@gmail.com}

...
\cvlistitem{API Engineering: Building, Scaling, Testing, Securing, whatever else!}
...
\cvlistitem{FastAPI, for building small services quickly}
\cvlistitem{Django, for building large services well}
...
\cvlistitem{Built an API test framework for a programmatic ad platform product using Python. This tested the API layer of the internal application using approximately 200 tests with Pytest and requests - https://github.com/amperser/proselint/commits?author=joshmgrant}
\cvlistitem{Built a simple RESTful API for generating random numberes called Corsica using FastAPI and Deta - https://github.com/joshmgrant/corsica}
...
\cvline{Art}{Current interests include work by Agnes Martin and Guido Molinari.}

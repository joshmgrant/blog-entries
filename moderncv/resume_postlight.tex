...
\section{Education}
\cventry{2007-2009}{MSc - Applied Mathematics}{Western University}{London}{Ontario}{Research area: Mathematical Biology}  % arguments 3 to 6 are optional
...
\cvlistitem{Remote and co-located positions}
\cvlistitem{Server-side development, including API development and maintenance}
\cvlistitem{Data-driven roles and teams making use of modern software methodologies}
\cvlistitem{Opportunities involving working on developer-side automation and tooling}
...
\cvlistitem{Development Tooling  - Jenkins CI, TravisCI, bash scripting, JIRA and Confluence}
%\cvcomputer{}{} {}{}
...
\cvline{Writing}{I've always enjoyed writing, both professionally or otherwise. My blog is called Simply the Test (\href{http://simplythetest.tumblr.com}{simplythetest.tumblr.com})}
\cvline{Podcasts}{Podcasting is the new blogging. Some that I've listened to include \href{https://www.thisamericanlife.org/podcast}{This American Life}, \href{http://www.angryweasel.com/ABTesting/}{AB Testing}, and Track Changes, the \emph{official} podcast of Postlight.com}

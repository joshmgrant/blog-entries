...
\cvlistitem{Roles working with building and automating software infrastructure}
...
\cvlistitem{Version Control - Git with Bitbucket, Bitbucket Server and GitHub}
\cvlistitem{Database Tooling - MS SQL Server, MySQL}
\cvlistitem{Automation Tooling  - Jenkins CI, TravisCI, TestNG, pytest, bash scripting}
\cvlistitem{Cloud Services - Google Cloud Platform (App Engine, Logging and API)}
%\cvcomputer{}{} {}{}

...
\cvlistitem{Test Automation: I've worked at all levels of the test automation pyramid and would like to continue to do so}
\cvlistitem{Java: I've built test frameworks with Selenium, JUnit and TestNG and worked with CucumberJVM and Spring Boot for testing work}
...
\cvlistitem{IntelliJ, the best IDE around in my opinion}
\cvlistitem{RestAssured, for building excellent REST API tests}
\cvlistitem{Keyword-Driven Testing, for scaling test automation}
...
\cvline{Art}{Current interests include work by Agnes Martin and Josef Albers.}

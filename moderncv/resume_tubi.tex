...
\cvlistitem{Playwright: I've worked with this in Typescript and look forward to using it again}
...
\cvlistitem{Visual Studio Code, my one stop shop for writing code in several languages}
\cvlistitem{npm, the best CLI for managing packages}
\cvlistitem{Taking short walks, for excellent debugging}

\newpage

\section{Tools I've Used}
\cvlistitem{JetBrains: Java with IntelliJ is great, and their other IDEs are as well}
...
\cvlistitem{Built a browser-based test framework in Playwright with Typescript for a SaaS-based scale-up}

Over the past two posts, I've [introduced Nerodia]() and also [given a sample of what Nerodia can do](). Now I'd like to show a sample of how a page object might look using Nerodia.
